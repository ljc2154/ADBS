...
knowledgegraph.py: python script containing program source code
Makefile: file containing steps to run program
transcript.txt: a file containing the output of our program on queries/questions from
	input files test-infobox.qfile and test-question.qfile
