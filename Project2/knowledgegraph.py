...
# Make sure script utilized correctly
args = sys.argv
if len(args) != 7 or args[1] != '-key' or (args[3] != '-q' and args[3] != '-f') or args[5] != '-t' (args[6] != 'infobox' and args[6] != 'question'
	print "Usage error: Format must be python knowledgegraph.py -key <Freebase API key> -q <query> -t <infobox|question>"
	print "or make ARGS=\"-key <Freebase API key> -q <query> -t <infobox|question>\""
	print "or python knowledgegraph.py -key <Freebase API key> -f <file of queries> -t <infobox|question>"
	print "or make ARGS=\" -key <Freebase API key> -f <file of queries> -t <infobox|question>\""
	return 1
api_key = 'AIzaSyBsXEX0SMoWRYtQDRHWMHehGqmRiGRgQow'
print 'Let me see...'

if not query.startswith('Who created') and not query.startswith('who created'):
